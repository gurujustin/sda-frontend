...
export const changeApproval = createAsyncThunk(
  ...
  async ({ token, provider, address, networkID }: IChangeApprovalAsyncThunk, { dispatch }) => {
    ...
    const glaContract = new ethers.Contract(addresses[networkID].SDA_ADDRESS as string, ierc20Abi, signer);
    const sglaContract = new ethers.Contract(addresses[networkID].sSDA_ADDRESS as string, ierc20Abi, signer);
    let approveTx;
