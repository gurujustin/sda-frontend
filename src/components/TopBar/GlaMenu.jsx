...
import { addresses, MAINNET, TOKEN_DECIMALS } from "../../constants";
...
function GlaMenu() {
  ...
  const sSDA_ADDRESS = addresses[networkID].sSDA_ADDRESS;
  const SDA_ADDRESS = addresses[networkID].SDA_ADDRESS;
  ...
  const id = "gla-popper";
  const daiAddress = addresses[networkID].DAI;
  return (
    <Box
      component="div"
            ...
            <Fade {...TransitionProps} timeout={100}>
              <Paper className="gla-menu" elevation={1}>
                <Box component="div" className="buy-tokens">
                  <Link
                    href={`https://pancakeswap.finance/swap?inputCurrency=${daiAddress}&outputCurrency=${SDA_ADDRESS}`}
                    target="_blank"
                    rel="noreferrer"
                  >
                  ...
                  {/* <Link
                    href={`https://swap.spiritswap.finance/#/add/${USDC_ADDRESS}/${SDA_ADDRESS}`}
                    target="_blank"
                    rel="noreferrer"
                  >
                    <Button size="large" variant="contained" color="secondary" fullWidth>
                ...
                {isEthereumAPIAvailable ? (
                  <Box className="add-tokens">
                    ...
                    <Box display="flex" flexDirection="row" justifyContent="space-between">
                      <Button variant="contained" color="secondary" onClick={addTokenToWallet("GLA", SDA_ADDRESS)}>
                        <SvgIcon
                      ...
                      <Button variant="contained" color="secondary" onClick={addTokenToWallet("sGLA", sSDA_ADDRESS)}>
                        <SvgIcon
